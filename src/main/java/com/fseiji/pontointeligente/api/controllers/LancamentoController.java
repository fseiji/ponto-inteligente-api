...
public class LancamentoController {
	...
	public ResponseEntity<Response<LancamentoDto>> adicionar(@Valid @RequestBody LancamentoDto lancamentoDto,
		...
		LOG.info("Adicionado lançamento: {}", lancamentoDto.toString());
		Response<LancamentoDto> response = new Response<LancamentoDto>();
		...
		lancamento = this.lancamentoService.persiste(lancamento);
	...
	/**
	 * Valida um funcionário, verificando se ele é existente no sistema
	 * 
	 * @param lancamentoDto
	 * @param result
	 */
