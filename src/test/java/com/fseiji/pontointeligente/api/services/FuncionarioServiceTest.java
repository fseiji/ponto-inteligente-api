...
import com.fseiji.pontointeligente.api.repositories.FuncionarioRepository;
...
public class FuncionarioServiceTest {
	...
	public void testBuscarFuncionarioPorCpf() {
		Optional<Funcionario> funcionario = this.funcionarioService.buscarPorCpf("22001295057");
		assertTrue(funcionario.isPresent());
	}
}
