...
import com.fseiji.pontointeligente.api.dtos.LancamentoDto;
...
import com.fseiji.pontointeligente.api.services.FuncionarioService;
...
public class LancamentoControllerTest {
	...
	public void testCadastrarLancamento() throws JsonProcessingException, Exception {
		...
		BDDMockito.given(this.lancamentoService.persiste(Mockito.any(Lancamento.class))).willReturn(lancamento);

		this.mvc.perform(MockMvcRequestBuilders.post(URL_BASE).content(this.obterJsonRequisicaoPost())
	...
	@Test
	@WithMockUser
	public void testCadastrarLancamentoFuncionarioIdInvalido() throws JsonProcessingException, Exception {
	...
	@Test
	@WithMockUser(username = "mimi@email.com", roles = { "ADMIN" })
	public void testRemoverLancamento() throws Exception {
		BDDMockito.given(this.lancamentoService.buscarPorId(Mockito.anyLong()))
				.willReturn(Optional.of(new Lancamento()));

		this.mvc.perform(MockMvcRequestBuilders.delete(URL_BASE + ID_LANCAMENTO).accept(MediaType.APPLICATION_JSON))
