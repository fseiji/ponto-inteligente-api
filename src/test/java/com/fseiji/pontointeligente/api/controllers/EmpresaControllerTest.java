...
public class EmpresaControllerTest {
	...
	private static final String CNPJ = "97262550000110";
	...
	public void testBuscarEmpresaCnpjInvalido() throws Exception {
		...
		this.mvc.perform(MockMvcRequestBuilders.get(BUSCAR_EMPRESA_CNPJ_URL + CNPJ).accept(MediaType.APPLICATION_JSON))
